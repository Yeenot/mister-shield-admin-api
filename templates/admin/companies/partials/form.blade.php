<div class="kt-portlet__body">
    <div class="kt-section kt-section--first">
        ...
        <div class="kt-section__body">
            ...
            {{-- timezone --}}
            <div class="form-group">
                <label>{{ __('staff/forms.companies_timezone') }} *</label>
                <div class="group-control {{ $errors->has('timezone') ? 'is-invalid' : ''}}">
                    <select name="timezone" class="form-control kt-selectpicker {{ $errors->has('timezone') ? 'is-invalid' : ''}}">
                        <option value="">{{ __('staff/forms.companies_select_timezone') }}</option>
                        @foreach(__('timezones') as $key => $timezone)
                            <option value="{{ $key }}"
                                {{ old('timezone', $company->timezone ?? '') == $key ? 'selected' : '' }}>{{ $timezone }}</option>
                        @endforeach
                    </select>
                </div>
