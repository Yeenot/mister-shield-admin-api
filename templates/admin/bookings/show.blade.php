            ...
            <div class="kt-section kt-section--first kt-section--last">
                <div class="kt-section__body">
                    ...
                    <div class="form-group">
                        ...
                        <br>
                        {{ optional($booking->created_at)->setTimezone(app('shared')->get('others')['timezone'])->format('d/m/Y H:i') }}
                    </div>
                    <div class="form-group">
                        <label>{{ __('staff/forms.bookings_booked_at') }}</label>
                        <br>
                        {{ optional($booking->booked_at)->setTimezone(app('shared')->get('others')['timezone'])->format('d/m/Y H:i:s') }}
                    </div>
                    <div class="form-group">
