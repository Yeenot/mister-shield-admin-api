...
class FaqService
{
    ...
    public function create($data)
    {
        ...
        $data['order'] = $this->generateOrder($data['faq_category_id']);
    ...
    {
        $faq = $this->getById($id);
        // Update current FAQ's order then generate a new one
        if ($faq->faq_category_id != $data['faq_category_id']) {
            $this->model->where('order', '>', $faq->order)
     ...
     * @return int
     */
    public function generateOrder($category)
    {
        return $this->model
