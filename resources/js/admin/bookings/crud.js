...
const app = new Vue({
    ...
    methods: {
        ...
        onFormSubmit(e) {
            ...
            // format booked at
            var el = $('input[name=booked_at]');
            var booked_at = el.val();
            if (vm.$helper.isNotNull(booked_at)) {
                var format = 'MM/DD/YYYY HH:mm';
                el.val(moment.tz(booked_at, format, vm.main.collection.shared.others.timezone).utc().format(format)); 
            }
            // other fields
