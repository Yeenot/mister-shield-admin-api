...
Route::group(['prefix' => 'v1', 'namespace' => 'Api\V1', 'middleware' => 'locale.api'], function () {
    // Locales
    Route::get('/locale/{country}/{language}', 'LocaleController@check')->name('api.locale');
    ...
    Route::group(['prefix' => 'companies'], function () {
        Route::group(['prefix' => '{company}'], function () {
            ...
            Route::get('completed-services/latest', 'LatestCompletedServiceController@index')->name('api.companies.completed_services.latest');
    ...
    Route::group(['prefix' => 'content'], function () {
        Route::get('/', 'ContentController@index')->name('api.content');
    });
});