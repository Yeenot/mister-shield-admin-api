...
Route::group(['prefix' => '{country?}/{locale?}', 'namespace' => 'Customer', 'middleware' => 'locale'], function() {
    ...
    Route::get('sitemap', 'SitemapController@index')->name('customer.sitemap');

    // Serviced locations
    Route::group(['prefix' => 'sanitized-locations'], function() {
    ...
    Route::group(['prefix' => 'verify'], function() {
        ...
        Route::get('{code}/{slug?}', 'VerifyController@results')->name('customer.verify.results');
    });
